    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form method="POST" action="{{ route('activites.store') }}" enctype="multipart/form-data">
                ...
                <!-- Image Upload -->
                <div class="mb-6">
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">{{ __('Activity image') }}</label>
                ...
                <div id="imagePreview" class="mb-6 hidden">
                    <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Preview') }}</label>
