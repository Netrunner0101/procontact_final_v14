...
@section('title', __('Edit Note') . ' - Pro Contact')

@section('content')
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">{{ __('Edit Note') }}</h1>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="priorite" name="priorite" required
                                ...
                                <option value="Basse" {{ old('priorite', $note->priorite) == 'Basse' ? 'selected' : '' }}>{{ __('Low') }}</option>
                                <option value="Normale" {{ old('priorite', $note->priorite) == 'Normale' ? 'selected' : '' }}>{{ __('Normal') }}</option>
                                <option value="Haute" {{ old('priorite', $note->priorite) == 'Haute' ? 'selected' : '' }}>{{ __('High') }}</option>
                                <option value="Urgente" {{ old('priorite', $note->priorite) == 'Urgente' ? 'selected' : '' }}>{{ __('Urgent') }}</option>
                            </select>
                            @error('priorite')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="p-4 bg-blue-50 rounded-lg">
                            ...
                            <div class="text-sm text-blue-700 space-y-1">
                                <p><strong>{{ __('Priority:') }}</strong> {{ $note->priorite }}</p>
                                <p><strong>{{ __('Created on:') }}</strong> {{ $note->created_at->format('d/m/Y à H:i') }}</p>
