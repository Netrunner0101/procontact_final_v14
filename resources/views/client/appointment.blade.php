...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">{{ __('Date and time') }}</label>
                        <p class="mt-1 text-sm text-gray-900">
                            {{ \Carbon\Carbon::parse($rendezVous->date_heure)->format('d/m/Y') }} {{ __('at') }} {{ \Carbon\Carbon::parse($rendezVous->date_heure)->format('H:i') }}
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('Reminders') }}</h3>
                <div class="space-y-3">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500">
                                {{ \Carbon\Carbon::parse($rappel->date_heure)->format('d/m/Y') }} {{ __('at') }} {{ \Carbon\Carbon::parse($rappel->date_heure)->format('H:i') }}
                            </p>
                        </div>
                    </div>
                    @endforeach
