...
@section('title', __('Dashboard - Pro Contact'))
...
<div class="container mx-auto px-4 py-6 lg:py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl lg:text-4xl font-bold text-gradient mb-2">{{ __('Dashboard') }}</h1>
                <p class="text-gray-600 text-lg">{{ __('Welcome, :name! Here is an overview of your activity.', ['name' => auth()->user()->prenom]) }}</p>
            </div>
                    ...
                    <div>
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 font-medium">{{ __('Contacts') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 font-medium">{{ __('Activities') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 font-medium">{{ __('Appointments') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 font-medium">{{ __('Reminders') }}</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-900">{{ __('Upcoming Reminders') }}</h2>
            </div>
            <div class="p-6">
                ...
                @else
                    <p class="text-gray-500">{{ __('No upcoming reminders') }}</p>
                @endif
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-900">{{ __('Recent Contacts') }}</h2>
            </div>
            <div class="p-6">
                ...
                @else
                    <p class="text-gray-500">{{ __('No recent contacts') }}</p>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="mt-8">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-gray-900">{{ __('Quick Actions') }}</h2>
            <p class="text-gray-600">{{ __('Quickly create new items') }}</p>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-4">
            ...
            <a href="{{ route('contacts.create') }}" class="btn btn-primary group flex-col h-auto py-4 space-y-2">
                ...
                <span class="text-sm font-medium">{{ __('New Contact') }}</span>
            </a>
            ...
            <a href="{{ route('activites.create') }}" class="btn btn-success group flex-col h-auto py-4 space-y-2">
                ...
                <span class="text-sm font-medium">{{ __('New Activity') }}</span>
            </a>
            ...
            <a href="{{ route('rendez-vous.create') }}" class="btn group flex-col h-auto py-4 space-y-2" style="background: linear-gradient(135deg, #8b5cf6, #7c3aed); color: white;">
                ...
                <span class="text-sm font-medium">{{ __('New Appointment') }}</span>
            </a>
            ...
            <a href="{{ route('rappels.create') }}" class="btn btn-warning group flex-col h-auto py-4 space-y-2">
                ...
                <span class="text-sm font-medium">{{ __('New Reminder') }}</span>
            </a>
            ...
            <a href="{{ route('notes.create') }}" class="btn group flex-col h-auto py-4 space-y-2" style="background: linear-gradient(135deg, #6366f1, #4f46e5); color: white;">
                ...
                <span class="text-sm font-medium">{{ __('New Note') }}</span>
            </a>
            ...
            @if(auth()->user()->isAdmin())
                ...
                <a href="{{ route('admin.clients.create') }}" class="btn group flex-col h-auto py-4 space-y-2" style="background: linear-gradient(135deg, #f97316, #ea580c); color: white;">
                    ...
                    <span class="text-sm font-medium">{{ __('New Client') }}</span>
                </a>
            @endif
            ...
            <a href="{{ route('statistiques.index') }}" class="btn btn-secondary group flex-col h-auto py-4 space-y-2">
                ...
                <span class="text-sm font-medium text-gray-700">{{ __('Statistics') }}</span>
            </a>
        </div>
    </div>
    ...
    <div class="mt-12 text-center">
        <div class="inline-flex items-center space-x-2 text-gray-500 text-sm">
            ...
            <span>{{ __('Pro Contact - Multi-company management system') }}</span>
        </div>
    </div>
</div>
@endsection
