...
<body>
    ...
    <section class="py-20 px-6">
        <div class="max-w-3xl mx-auto text-center rounded-2xl p-12" style="background: #ffffff; box-shadow: 0 20px 40px rgba(27,28,26,0.05);">
            <h2 class="text-3xl md:text-4xl font-bold mb-4" style="color: #1b1c1a;">{{ __('Ready to get started?') }}</h2>
            <p class="text-lg mb-8" style="color: #44483e;">{{ __('Create your account and start managing your professional contacts today.') }}</p>
